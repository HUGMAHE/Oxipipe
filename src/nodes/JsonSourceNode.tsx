...
function JsonSourceNode({ data, selected }: NodeProps<JsonSourceData>) {
  ...
  return (
    <div className={`rf-node node-source ${selected ? "selected" : ""}`} style={{ minWidth: 220 }}>
      <div className="rf-node-header source">
        <span className="rf-node-title">JSON Source</span>
        ...
        <div className="node-field">
          ...
          <div style={{ display: "flex", gap: 4 }}>
            <input
              ...
              placeholder="Select a JSON / NDJSON file…"
...
export default memo(JsonSourceNode);
