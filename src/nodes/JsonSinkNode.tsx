...
export interface JsonSinkData {
  config: NodeConfig;
  onConfigChange: (config: NodeConfig) => void;
}

function JsonSinkNode({ data, selected }: NodeProps<JsonSinkData>) {
  ...
  return (
    <div className={`rf-node node-sink ${selected ? "selected" : ""}`} style={{ minWidth: 220 }}>
      ...
      <div className="rf-node-header sink">
        <span className="rf-node-title">JSON Export</span>
        ...
        <div className="node-field">
          ...
          <div style={{ display: "flex", gap: 4 }}>
            <input
              ...
              placeholder="e.g. C:/data/output.json"
...
export default memo(JsonSinkNode);
